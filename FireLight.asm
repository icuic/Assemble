...
CMP_RESUME0	EQU	7DH		;检测到电源电压大于此数值时，表示市电供电已恢复，应关闭应急.(1.296V -> 0x84)
CMP_RESUME1	EQU	7EH
...
CHK_PWR_SUPPLY:				;检查供电是否正常
	...
	BC	ENBALE_EMERGENCY	;如果停电,则打开应急
...
CHK_PWR_RESUME:
	...
	BC	CHK_PWR_SUPPLY_END	;如果1.115v < X < 1.296V

	LDA	ABNORMAL_STA		;
	BA0	EXIT_EMERGENCY		;如果上一次为停电，
	JMP	CHK_PWR_SUPPLY_END

EXIT_EMERGENCY:
	CALL	EMERGENCY_DISABLE

	SBI	CNT0_EMERGENCY,	0CH	;和5分钟比较
	LDI	TBR,		02H
	SBC	CNT1_EMERGENCY
	LDI	TBR,		01H
	SBC	CNT2_EMERGENCY
	...
	SBI	CNT0_EMERGENCY,	08H	;和30分钟比较
	LDI	TBR,		00H
	SBC	CNT1_EMERGENCY
	LDI	TBR,		07H
	SBC	CNT2_EMERGENCY
